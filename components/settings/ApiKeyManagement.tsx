...
import { Plus, Key, ExternalLink, FolderPlus, Folder, Trash2, Edit2, Box, ChevronDown, ChevronRight, GripVertical } from 'lucide-react';
...
import { KnownModelsPool } from './KnownModelsPool';
import { ApiKeyBatchImport } from './ApiKeyBatchImport';
    ...
    <div className="space-y-4">
        ...
        <div className="space-y-4">
            ...
            <ApiKeyBatchImport 
                ...
                batchKeysInput={batchKeysInput}
                setBatchKeysInput={setBatchKeysInput}
                isBatchTesting={isBatchTesting}
                handleAddKey={() => handleAddKey()}
                handleImportSingleKeyTrigger={handleImportSingleKeyTrigger}
                handleImportSingleKeyConfig={handleImportSingleKeyConfig}
                handleTestAndBatchImport={handleTestAndBatchImport}
